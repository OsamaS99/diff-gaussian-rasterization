    ...
    bool debug)
{
    ...
    // Step 1: Allocate and initialize usageCounts
    if (d_usageCounts == nullptr)
    {
    ...
    // **Remove the redundant SortPairs call here**
    // The BinningState::fromChunk already performs sorting
    // Thus, we do not need to sort again here.
    ...
    CHECK_CUDA(FORWARD::render(
        ...
        background,
        out_color,
        d_usageCounts), debug); // Pass usageCounts
